...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173","http://localhost:5174", "http://localhost:3000", "http://157.66.218.164", "https://cinema-fe-rho.vercel.app",
                "http://cinemabookcdh.duckdns.org")); // Link Frontend của anh
